...
public class Motorcycle {
    ...
    @Size(max = 20, message = "VIN is maximum 20 characters in length.")
    private String vin;
    @NotEmpty(message = "You must supply a value for make.")
    @Size(max = 20, message = "Make is maximum 20 characters in length.")
    private String make;
    @NotEmpty(message = "You must supply a value for model.")
    @Size(max = 20, message = "Model is maximum 20 characters in length.")
    ...
    @Size(max = 20, message = "Color is maximum 20 characters in length.")
